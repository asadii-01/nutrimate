...
import { LoginRequestSchema, RefreshRequestSchema, RegisterRequestSchema } from "@nutrimate/shared-types";
...
authRouter.post("/register", authLimiter, validate(RegisterRequestSchema), async (req, res, next) => {
  try {
